...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(true){
            ...
            System.out.println("|           7. Info Rank Akun               |");
            System.out.println("|           8. Tambah Stok Akun(overloading)|");
            ...
            switch (menu) {
                ...
                case 7:
                    System.out.println("=============================================");
                    System.out.println("|         Info Rank Akun              |");
                    System.out.println("=============================================");
                    System.out.println("Masukkan index Akun: ");
                    int indexAkun = Integer.parseInt(br.readLine());
                    if (indexAkun >= 0 && indexAkun < Akn.size()) {
                        Akun akun = Akn.get(indexAkun);
                        System.out.println("Rank Akun:");
                        akun.rankInfo(); 
                    } else {
                        System.out.println("Index Akun tidak valid.");
                    }
                    break;
                case 8:
                    String idaknWithoutRank = "AKUN 0" + nextAkunId++;
                    System.out.println("=============================================");
                    System.out.println("|          Tambah Stok Akun tanpa Rank      |");
                    System.out.println("=============================================");
                    System.out.println("Masukkan Nama Game");
                    String NamaWithoutRank = br.readLine();
                    System.out.println("Harga");
                    int hargaWithoutRank = Integer.parseInt(br.readLine());
                    Akun aknWithoutRank = new Akun(NamaWithoutRank, hargaWithoutRank, idaknWithoutRank);
                    Akn.add(aknWithoutRank);
                    AJshop ajWithoutRank = new AJshop(NamaWithoutRank, hargaWithoutRank, idaknWithoutRank, idaknWithoutRank);
                    ajWithoutRank.cekclass();
                    break;
                case 9:
